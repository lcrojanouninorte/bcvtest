      ...
      localDB.sync_local = function(usersname) {
        ...
        return $q(function(resolve, reject) {
            ...
            localDB.replicate.from(db, {
                ...
                console.log('complete1: ' + JSON.stringify(info));
                ...
                localDB.sync(db, {
                    ...
                    localDB.isActive = false;
                    console.log('complete2: ' + JSON.stringify(info));
                  ...
                  .on('denied2', function(err) {

                    // console.log('denied: ' + JSON.stringify(err));
                  })
                  .on('error2', function(err) {
              ...
              .on('error', function(err) {
                ...
                .on('complete', function(info) {
                  localDB.isActive = false;
                  console.log('complete3: ' + JSON.stringify(info));
                }).on('active', function(data) {
                  localDB.isActive = true;
                  //show loading
                  console.log('active3');
